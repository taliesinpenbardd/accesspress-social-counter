                ...
                switch ($social_profile) {
                    case 'facebook':
                        ...
                        <a  class="apsc-facebook-icon clearfix" href="<?php echo "http://facebook.com/" . $facebook_page_id; ?>" target="_blank">
                            <div class="apsc-inner-block">
                                <span class="social-icon"><i class="fa fa-facebook apsc-facebook"></i><span class="media-name"><?php _e( 'Facebook', 'accesspress-social-counter' ); ?></span></span>
                                <span class="apsc-count"><?php echo $count; ?></span><span class="apsc-media-type"><?php _e( 'Fans', 'accesspress-social-counter' ); ?></span>
                            </div>
                        </a>
                            <?php
                            break;
                        ...
                        <a  class="apsc-twitter-icon clearfix"  href="<?php echo 'http://twitter.com/'.$apsc_settings['social_profile']['twitter']['username'];?>" target="_blank">
                            <div class="apsc-inner-block">
                                <span class="social-icon"><i class="fa fa-twitter apsc-twitter"></i><span class="media-name"><?php _e( 'Twitter', 'accesspress-social-counter' ); ?></span></span>
                                <span class="apsc-count"><?php echo $count; ?></span><span class="apsc-media-type"><?php _e( 'Followers', 'accesspress-social-counter' ); ?></span>
                            </div>
                        </a>
                    <?php
                        break;
                    case 'googlePlus':
                        ...
                        <a  class="apsc-google-plus-icon clearfix" href="<?php echo $social_profile_url; ?>" target="_blank">
                            <div class="apsc-inner-block">
                                <span class="social-icon"><i class="apsc-googlePlus fa fa-google-plus"></i><span class="media-name"><?php _e( 'google+', 'accesspress-social-counter' ); ?></span></span>
                                <span class="apsc-count"><?php echo $count; ?></span><span class="apsc-media-type"><?php _e( 'Followers', 'accesspress-social-counter' ); ?></span>
                            </div>
                        </a>
                        <?php
                        ...
                        case 'instagram':
                            ...
                            <a  class="apsc-instagram-icon clearfix" href="<?php echo $social_profile_url; ?>" target="_blank">
                                <div class="apsc-inner-block">
                                    <span class="social-icon"><i class="apsc-instagram fa fa-instagram"></i><span class="media-name"><?php _e( 'Instagram', 'accesspress-social-counter' ); ?></span></span>
                                    <span class="apsc-count"><?php echo $count; ?></span><span class="apsc-media-type"><?php _e( 'Followers', 'accesspress-social-counter' ); ?></span>
                                </div>
                            </a>
                            <?php
                        ...
                        <a class="apsc-youtube-icon clearfix" href="<?php echo $social_profile_url; ?>" target="_blank">
                            <div class="apsc-inner-block">
                                <span class="social-icon"><i class="apsc-youtube fa fa-youtube"></i><span class="media-name"><?php _e( 'Youtube', 'accesspress-social-counter' ); ?></span></span>
                                <span class="apsc-count"><?php echo $count; ?></span><span class="apsc-media-type"><?php _e( 'Subscriber', 'accesspress-social-counter' ); ?></span>
                            </div>
                        </a>
                        <?php
                            break;
                        ...
                        <a class="apsc-soundcloud-icon clearfix" href="<?php echo $social_profile_url; ?>" target="_blank">
                            <div class="apsc-inner-block">
                                <span class="social-icon"><i class="apsc-soundcloud fa fa-soundcloud"></i><span class="media-name"><?php _e( 'Soundcloud', 'accesspress-social-counter' ); ?></span></span>
                                <span class="apsc-count"><?php echo $count; ?></span><span class="apsc-media-type"><?php _e( 'Followers', 'accesspress-social-counter' ); ?></span>
                            </div>
                        </a>
                        <?php
                        ...
                        <a class="apsc-dribble-icon clearfix" href="<?php echo $social_profile_url; ?>" target="_blank">
                            <div class="apsc-inner-block">
                                <span class="social-icon"><i class="apsc-dribbble fa fa-dribbble"></i><span class="media-name"><?php _e( 'dribble', 'accesspress-social-counter' ); ?></span></span>
                                <span class="apsc-count"><?php echo $count; ?></span><span class="apsc-media-type"><?php _e( 'Followers', 'accesspress-social-counter' ); ?></span>
                            </div>
                        </a>
                        <?php
                        ...
                        <a class="apsc-edit-icon clearfix" href="javascript:void(0);">
                            <div class="apsc-inner-block">
                                <span class="social-icon"><i class="apsc-posts fa fa-edit"></i><span class="media-name"><?php _e( 'Post', 'accesspress-social-counter' ); ?></span></span>
                                <span class="apsc-count"><?php echo $count; ?></span><span class="apsc-media-type"><?php _e( 'Post', 'accesspress-social-counter' ); ?></span>
                            </div>
                        </a>
                        <?php
                            break;
                        ...
                        <a class="apsc-comment-icon clearfix" href="javascript:void(0);">
                            <div class="apsc-inner-block">
                                <span class="social-icon"><i class="apsc-comments fa fa-comments"></i><span class="media-name"><?php _e( 'Comment', 'accesspress-social-counter' ); ?></span></span>
                                <span class="apsc-count"><?php echo $count; ?></span><span class="apsc-media-type"><?php _e( 'Comments', 'accesspress-social-counter' ); ?></span>
                            </div>
                        </a>
                        <?php
                            break;
